...
@section('contenido-dinamico')
    <div class="content-wrapper">
        <div class="container">
            <h2 class="display-5 fw-bold text-body-emphasis">Maquinaria inactiva</h2>
            <div class="pt-3 px-4">
                <a href="machineries"><button type="button" class="btn btn-primary">Ver maquinaria activa</button></a>
                <a href="maintenance_machineries"><button type="button" class="btn btn-primary">Ver maquinaria en mantenimiento</button></a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($machineries as $machineryItem)
                        <tr>
                            ...
                            <td>
                                @if ($machineryItem->state_name == 'Inactivo')
